...
td_ctx_t td1_ctx = {
	.layer = 1, // Слой
	.tap_key = KC_APP, // Одиночный тап
	.is_holding = false }; // Удержание
td_ctx_t td2_ctx = {
	.layer = 3,
	.tap_key = KC_APP,
	.is_holding = false };
//td_ctx_t td_new_ctx = { .layer = 4, .tap_key = KC_XXX, ... }; Что делает новая клавиша
...
tap_dance_action_t tap_dance_actions[] = {
    [TD_L1] = {							// Для клавиши 1 (MAC_FN)
        .fn = { 
			NULL, 						// Не используется 
			td_finished, 				// Обработчик событий
			td_reset },					// Обработчик сброса
        .user_data = (void *)&td1_ctx,	// Контекст для MAC_FN
    },
    [TD_L3] = {
        .fn = { NULL, td_finished, td_reset },
        .user_data = (void *)&td2_ctx,
    },
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC] = LAYOUT_ansi_90(
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD,                                KC_SPC,                                     KC_RCMMD, KC_ROPTN, TD(TD_L1),  KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_ansi_90(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  KC_INS,     _______,    KC_PAUS,  _______,  _______,    _______,    _______,  _______,  _______,
        RGB_TOG,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,    _______,    _______,  _______,  _______,    _______,    BT_HST1,  BT_HST2,  BT_HST3,
    ...
    [WIN] = LAYOUT_ansi_90(
        ...
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,       KC_COMM,    KC_DOT,   KC_SLSH,              KC_RSFT,              KC_UP,
        KC_LCTL,  KC_LWIN,  KC_LALT,                                 KC_SPC,                                     KC_RALT,  KC_RGUI,  TD(TD_L3),  KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT),
